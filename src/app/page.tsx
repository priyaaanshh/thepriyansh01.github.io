...
const Home = () => {
  return (
    <div className='snap-y snap-mandatory flex flex-col items-center justify-start h-screen w-full px-4 overflow-y-scroll no-scrollbar'>
      <div className="snap-start shrink-0 min-h-screen w-full max-w-[850px] flex flex-col justify-center items-center gap-5">
        <Dashboard />
      </div>
      <div className="snap-start shrink-0 min-h-screen w-full max-w-[850px] flex flex-col justify-center items-center gap-5">
      ...
      <div className="snap-start shrink-0 min-h-screen w-full max-w-[850px] flex flex-col justify-start items-center gap-5">
        <div className="my-5"></div>
