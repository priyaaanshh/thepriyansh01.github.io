        ...
        >
          <div className="flex flex-col justify-center items-center gap-5 w-full max-w-[850px] my-4">
            ...
            <div className="flex items-center justify-end w-full">
              <button
                type="submit"
                className="flex justify-center items-center gap-3 w-full sm:w-max px-8 py-2 font-bold rounded-lg bg-gradient border-2 shadow-lg shadow-black/25 hover:scale-110 duration-300 hover:-rotate-1"
              >
                <span>Send</span>
                <Send size={25} />
              </button>
