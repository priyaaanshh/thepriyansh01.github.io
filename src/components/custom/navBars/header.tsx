...
const Header = () => {
    ...
    return (
        <div className='z-10 flex flex-col justify-center items-center fixed top-0 w-full py-2'>
            ...
            <div className='flex justify-center items-center my-5 bg-gradient text-secondary-foreground backdrop-blur rounded-[var(--radius)] px-4 py-2 text-3xl cursor-pointer select-none'>Website in devlopment phase</div>
        </div>
    )
}
