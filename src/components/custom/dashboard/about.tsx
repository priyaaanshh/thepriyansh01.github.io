...
const About = () => {
    return (
        <section className='flex flex-col justify-center items-center w-full my-16 max-w-[1080px]'>
            <span className='bg-gradient text-gradient text-5xl font-bold my-7'>About Me</span>
            <div className='flex flex-col justify-center items-center text-xl text-center w-full gap-10'>
                <p>
                    Hey there! My name is Priyansh and I am currently a final year student with a huge interest in web development. I have always been drawn to the world of coding and I am constantly looking for ways to challenge myself and improve my skills. My experience in web development includes working with Javascript, Express, React, NextJS, and Node.js to build user-friendly and efficient web applications. I am particularly skilled in the MERN stack and have a strong understanding of its components.
                </p>
                <p>
