    ...
    return (
        <section className='flex flex-col justify-center items-center gap-5 w-full h-screen max-w-[1080px] px-4 py-2'>
            ...
            <div className="flex flex-wrap justify-center items-center gap-8 px-4 my-3">
                <a href="https://github.com/thepriyansh01" target="_blank" className='hover:rotate-[360deg] duration-700 hover:text-yellow-500'>
                    <GitHubLogoIcon height='40' width="40" />
                </a>
                <a href="https://www.linkedin.com/in/priyansh-sahu-ab9380202/" target="_blank" className='hover:rotate-[360deg] duration-700 hover:text-yellow-500'>
                    <LinkedInLogoIcon height='40' width="40" />
                </a>
                <a href="https://twitter.com/_thepriyansh01" target="_blank" className='hover:rotate-[360deg] duration-700 hover:text-yellow-500'>
                    <TwitterLogoIcon height='40' width="40" />
                </a>
                <a href="https://www.instagram.com/_thepriyansh/" target="_blank" className='hover:rotate-[360deg] duration-700 hover:text-yellow-500'>
                    <InstagramLogoIcon height='40' width="40" />
                </a>
                <a href="https://discord.gg/SRZYjv3Q" target="_blank" className='hover:rotate-[360deg] duration-700 hover:text-yellow-500'>
                    <DiscordLogoIcon height='40' width="40" />
                </a>
                <a href="mailto:priyansh.sahu.cer21@iitbhu.ac.in" target="_blank" className="hover:rotate-[360deg] duration-700 hover:text-yellow-500">
            ...
            <div className="flex flex-wrap justify-center items-center w-full px-4 gap-5 md:gap-10 font-semibold text-2xl">
                <a href='mailto:priyansh.sahu.cer21@iitbhu.ac.in' target="_blank" className='flex justify-center items-center gap-3 w-full sm:w-max px-8 py-2 rounded-[var(--radius)] btn-gradient border-2 shadow-lg shadow-black/25 hover:scale-110 duration-300 hover:-rotate-1'>
